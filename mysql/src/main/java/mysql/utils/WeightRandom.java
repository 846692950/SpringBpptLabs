...
public class WeightRandom<T> {
    ...
    public static void main(String[] args) {
        ...
        ItemWithWeight<String> server1 = new ItemWithWeight<>("server1", 10);
        ItemWithWeight<String> server2 = new ItemWithWeight<>("server2", 11);
        ItemWithWeight<String> server3 = new ItemWithWeight<>("server3", 50);
        ItemWithWeight<String> server4 = new ItemWithWeight<>("server4", 99);
        WeightRandom<String> weightRandom = new WeightRandom<>(Arrays.asList(server1, server2, server3, server4));
...
//                .forEach(entry -> System.out.println(entry.getKey() + ", hit:" + entry.getValue()));
